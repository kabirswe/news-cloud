...
import {CloseCircleSharp, CalenderOutline, LineLogo} from '../../mod-assets/svgComp';
...
export default class Facebook extends Component {
  ...
  saveData = () => {
    ...
    this.props.getLineData(this.state.snsData);

    this.props.closeLineModal();
  ...
  getData = () => {
    ...
    AxiosService.get(ApiService.SNS_POST_GET(this.props.articleId, 3), false)
      .then((result) => {
  ...
  componentDidUpdate() {
    let {lineModal, isLineModalOpened, localData} = this.props;
    let {isLoading, loadData, syncWithLocalData, isCloseModal} = this.state;
    if (lineModal && !isLineModalOpened && loadData) {
      this.setState({
        loadData: false,
        isLoader: true
      });
    ...
    if (isLineModalOpened && syncWithLocalData) {
            ...
            {isLoader ? (
              ...
              <>
                      ...
                      <div className="date-picker">
                        ...
                        <DateInput
                          ...
                          minDate={
                            ...
                            // : new Date()
                            snsData.date? this.dateParseSafari(snsData.date) : new Date()
                          }
                          showTimeSelect
                ...
                <div className="modal-buttons">
                  <button
                    onClick={() => this.closeLineModal('save')}
